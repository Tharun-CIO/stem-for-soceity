  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        ...
        {/* Tagline */}
        <h1 className="text-white text-4xl md:text-6xl font-light tracking-wide drop-shadow-2xl max-w-6xl mx-auto leading-tight mb-12">
        ...
        <Button 
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white px-12 py-4 text-xl font-semibold rounded-full shadow-2xl hover:scale-105 transition-all duration-300"
        >
          Get Started
        </Button>
      </div>
