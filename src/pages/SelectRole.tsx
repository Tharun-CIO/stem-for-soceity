    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 text-center">
          ...
          <div className="w-80 h-80 mb-4 flex items-center justify-center">
            <div className="relative">
              {/* DNA Helix circular design */}
              <div className="w-64 h-64 border-4 border-white/60 rounded-full flex items-center justify-center relative">
                {/* Inner DNA helixes */}
                ...
                <div className="absolute top-4 left-1/2 w-2 h-2 bg-white/60 rounded-full transform -translate-x-1/2"></div>
                <div className="absolute bottom-4 left-1/2 w-2 h-2 bg-white/60 rounded-full transform -translate-x-1/2"></div>
                <div className="absolute left-4 top-1/2 w-2 h-2 bg-white/60 rounded-full transform -translate-y-1/2"></div>
                <div className="absolute right-4 top-1/2 w-2 h-2 bg-white/60 rounded-full transform -translate-y-1/2"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full max-w-2xl bg-white/30 backdrop-blur-lg border border-white/20 shadow-2xl flex flex-col justify-center px-12 py-16 relative">
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div 
              onClick={handlePartnerIndividual}
              className="bg-white/60 backdrop-blur-sm border border-white/30 rounded-2xl p-8 hover:bg-white/70 transition-all duration-200 cursor-pointer group shadow-lg"
            >
            ...
            <div 
              onClick={handlePartnerInstitution}
              className="bg-white/60 backdrop-blur-sm border border-white/30 rounded-2xl p-8 hover:bg-white/70 transition-all duration-200 cursor-pointer group shadow-lg"
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
