            ...
            <div className="w-full max-w-lg">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 text-lg">
                  Partner with us as a campus ambassador or institution.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <Link to="/campus-ambassador-signup" className="block">
                  <div className="bg-white border border-gray-200 rounded-xl p-6 hover:bg-gray-50 hover:border-blue-300 transition-all duration-200 hover:shadow-md cursor-pointer group relative">
                    <ArrowWithTail />
                    <div className="pr-8">
            ...
            <div className="relative z-10 max-h-[60vh] overflow-y-auto flex items-start justify-center px-4 pt-8 pb-4">
              <div className="w-full max-w-sm">
                ...
                <div className="space-y-4">
                  <Link to="/campus-ambassador-signup" className="block">
                    <div className="bg-white border border-gray-200 rounded-xl p-4 hover:bg-gray-50 transition-colors cursor-pointer relative">
                      <ArrowWithTail />
                      <div className="pr-8">
